...
class XlsUploader {
    ...
    public function createTableFromXls(string $directory,string $filename, string $tablename): void {
        $fileExt = pathinfo($filename, PATHINFO_EXTENSION);
        //$fileExt = $directory . '/' . $filename;
...
/*------------------------------Version 2 only created table now GOOD--------------------------------------------------------------*/    
...
/*--------------------------------------------------------------------------------------------*/    
/*--------------------------------------------------------------------------------------------*/    
/*----Version 3  created table and insert  GOOD--------------------------------------------------*/    
